...
def instructions():
    ...
    print()
    print("The Aim of the game is to guess")
    print("the random number generated by ")
    print("the computer. There are 2 modes")
    print()
    print("Mode 1: guess a number between 1 and 100")
    print("Mode 2: guess a number between your choice")
    print()
    print("When you guess you will be told")
    print("if you guessed lower or higher ")
    print("then the number generated. The ")
    print("amount of guesses you get will ")
    print("be determined by the number you")
    print("are guessing between.")
    print()
